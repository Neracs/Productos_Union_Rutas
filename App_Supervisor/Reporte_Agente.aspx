<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Reporte_Agente.aspx.cs" Inherits="App_Supervisor.Formulario_web12" %>
...
<div > 
    ...
    <table>
        <tr>
            <td>
                <asp:TextBox ID="textbox_Agente" runat="server"></asp:TextBox>
                <asp:Button ID="boton_buscar"  Text="Buscar" OnClick="evento_boton_buscar" runat="server"/>            
                <asp:GridView  Visible="false" ID="Reporte_agente" runat="server" AutoGenerateColumns="False" CellPadding="4"
