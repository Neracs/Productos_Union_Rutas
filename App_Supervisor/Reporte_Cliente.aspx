<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Reporte_Cliente.aspx.cs" Inherits="App_Supervisor.Formulario_web13" %>
    ...
    <table>
        <tr>
            <td>
                ...
                <asp:GridView  Visible="false" ID="Reporte_cliente" runat="server" AutoGenerateColumns="false" CellPadding="4"
