...
namespace App_Supervisor
{
    public partial class Formulario_web12 : System.Web.UI.Page
    {
        ...
        {
            if (oProxy.Validardni(textbox_Agente.Text))
            {
                dt = pro_Supervisor.ObtenerReporteAgente(textbox_Agente.Text);
                Reporte_agente.DataSource = dt;
                Reporte_agente.DataBind();
                Reporte_agente.Visible = true;
