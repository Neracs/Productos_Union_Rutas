<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Reporte_Fecha.aspx.cs" Inherits="App_Supervisor.Formulario_web15" %>
...
<div > 
    ...
    <table>
        <tr>
            <td>
                <asp:TextBox ID="textbox_Fecha" runat="server"></asp:TextBox>(dd/mm/aaaa)                         
                <asp:Button ID="boton_buscar"  Text="Buscar" OnClick="evento_boton_buscar" runat="server"/>                            
                <asp:GridView  Visible="false" ID="Reporte_fecha" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ForeColor="#333333" GridLines="None">
                            <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                            <Columns>
                                <asp:ButtonField ButtonType="Button" CommandName="Select" Text=">>" />
                                <asp:BoundField DataField="Fecha" HeaderText="Fecha" SortExpression="Fecha" />
                                <asp:BoundField DataField="AgentedeVentas" HeaderText="AgentedeVentas" SortExpression="AgentedeVentas" />
