<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Reporte_Ruta.aspx.cs" Inherits="App_Supervisor.Formulario_web14" %>
...
<div > 
    ...
    <table>
        <tr>
            <td>
                <asp:DropDownList ID="drop_ruta" runat="server"></asp:DropDownList>
                <asp:Button ID="boton_buscar"  Text="Buscar" OnClick="evento_boton_buscar" runat="server"/>          
                <asp:GridView  Visible="false" ID="Reporte_Ruta" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="AgenteVentas" HeaderText="AgenteVentas" SortExpression="AgenteVentas" />
